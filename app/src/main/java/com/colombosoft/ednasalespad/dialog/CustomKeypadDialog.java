...
public class CustomKeypadDialog extends Dialog {
    ...
    private ImageButton backspace, btnOk, btnCancel;
    private Button btn0, btn1, btn2, btn3, btn4, btn5, btn6, btn7, btn8, btn9;
    private Button btnPointFive;
    private boolean showPointFive;
    private boolean pointFiveClicked = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backspace = (ImageButton)findViewById(R.id.dialog_keypad_img_back);
        btnOk = (ImageButton)findViewById(R.id.btn_ok);
        btnCancel = (ImageButton)findViewById(R.id.btn_cncl);
...
//        String val = String.valueOf(newValue);
//        value.setText(val);
//        if(!val.equalsIgnoreCase("0.0") && val.contains(".")){
//            pointFiveClicked = true;
//            btnPointFive.setVisibility(View.INVISIBLE);
//            btnPointFive.setEnabled(false);
//        }
